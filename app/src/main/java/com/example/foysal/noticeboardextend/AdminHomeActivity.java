...
public class AdminHomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Id=SuperAdminId;
            post_url = "http://192.168.10.7/notice/PostVarsity.php";
        }
        else
        {
            Id=AdminId;
            post_url = "http://192.168.10.7/notice/PostInDiscipline.php";
        }
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Toast.makeText(getApplicationContext(),"Check = "+check+" File Name = "+showfile.getText().toString(),Toast.LENGTH_SHORT).show();
                ...
                {
                   FileName=fileName;
                   //Toast.makeText(getApplicationContext(),"In File section",Toast.LENGTH_SHORT).show();
                }
                else {
                    //notice post request
 ...
 private void checkPermissionsAndOpenFilePicker() {
    ...
    public void onActivityResult(int requestCode, int resultCode, final Intent data) {
        ...
        {
            progress=new ProgressDialog(AdminHomeActivity.this);
