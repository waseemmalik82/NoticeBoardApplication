...
public class FavoriteNotice extends Fragment {


    String newNotice_url="http://192.168.10.7/notice/FavoriteNotice.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_favorite_notice, container, false);
