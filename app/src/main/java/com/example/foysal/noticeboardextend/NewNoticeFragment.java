...
public class NewNoticeFragment extends Fragment {
    ...
    String newNotice_url = "http://192.168.10.7/notice/NewNotice.php";
    String clickk= "http://192.168.10.7/notice/Seen.php";
    String favorite= "http://192.168.10.7/notice/Favorite.php";

    private List<Notice> NoticeList = new ArrayList<>();
    private RecyclerView recyclerView;
    private NoticeAdapter mAdapter;

    String discipline, batch,Seen,noticeId,fav;
    int userId;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_new_notice, container, false);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getContext(),
            ...
            public void onClick(View view, final int position) {
                ...
                sub.putExtras(bundl);
                //make notice seen
                StringRequest strin = new StringRequest(Request.Method.POST, clickk,new Response.Listener<String>() {
                    @Override
                ...
                Mysingleton.getInstance(getContext()).addToRequestque(strin);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i < length; i++) {
                        ...
                        String Sf = jsonObject.getString("ShowFile");
                        Notice Notice = new Notice(tit, des, "Posted By: " + fn, nId, dat, bat, fl,Sf);
            ...
            StringRequest stringReques = new StringRequest(Request.Method.POST,favorite, new Response.Listener<String>()
            {
                ...
                public void onResponse(String response)
                {
                    try
                    {
                        ...
                        if (code.equals("Success"))
                        {
                            Toast.makeText(getContext(),"this notice is add on fav",Toast.LENGTH_LONG).show();
