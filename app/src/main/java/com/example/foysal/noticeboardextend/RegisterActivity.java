...
public class RegisterActivity extends AppCompatActivity {
    ...
    //work of sign up
    String reg_url = "http://192.168.10.7/notice/SignUpUser.php";

    String user_url = "http://192.168.10.7/notice/DisciplineList.php";
    @Override
    ...
    public void  setDiscipline()
    {
        ...
        disciplinelist.add("BBA");
        disciplinelist.add("BSES");
        disciplinelist.add("MCS");
        disciplinelist.add("MBA");
        disciplinelist.add("MSES");
    }
