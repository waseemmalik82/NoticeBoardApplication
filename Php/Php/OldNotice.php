...
$Seen="disciplineseen";
$table="discipline";
$sqll="SELECT $table.Title,$table.Description,$table.FileName,$table.ShowFile,$table.NoticeId,$table.Date from $table where NoticeId IN(SELECT NoticeId from disciplineseen where UserId like '$UserId' order by $table.Date DESC)";
...
$Seen="seenvarsity";
$table="varsitynotice";
$sqlll="SELECT $table.Title,$table.Description,$table.FileName,$table.ShowFile,$table.NoticeId,$table.Date from $table where $table.NoticeId IN(SELECT NoticeId from seenvarsity where UserId like '$UserId' order by $table.Date DESC)";
